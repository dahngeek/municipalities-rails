...
class NeighborhoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create neighborhood" do
    assert_difference('Neighborhood.count') do
      post neighborhoods_url, params: { neighborhood: { block_count: @neighborhood.block_count, municipality_id: @neighborhood.municipality_id, name: @neighborhood.name, population: @neighborhood.population } }
    end
  ...
  test "should update neighborhood" do
    patch neighborhood_url(@neighborhood), params: { neighborhood: { block_count: @neighborhood.block_count, municipality_id: @neighborhood.municipality_id, name: @neighborhood.name, population: @neighborhood.population } }
