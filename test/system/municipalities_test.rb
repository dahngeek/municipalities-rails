...
class MunicipalitiesTest < ApplicationSystemTestCase
  ...
  test "creating a Municipality" do
    ...
    fill_in "Url", with: @municipality.URL
    fill_in "Foundation year", with: @municipality.foundation_year
    fill_in "Mail", with: @municipality.mail
    fill_in "Mayor", with: @municipality.mayor_id
